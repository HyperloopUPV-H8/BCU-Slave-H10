...
Board::Board()
    : motor_driver(
          {Pinout::buffer_1_enable_pin, Pinout::buffer_2_enable_pin,
          ...
          {Pinout::phase_u_pwm_a_pin, Pinout::phase_u_pwm_b_pin},
          {Pinout::phase_u_negated_pwm_a_pin,
           Pinout::phase_u_negated_pwm_b_pin},
          {Pinout::phase_v_pwm_a_pin, Pinout::phase_v_pwm_b_pin},
          {Pinout::phase_v_negated_pwm_a_pin,
           Pinout::phase_v_negated_pwm_b_pin},
          {Pinout::phase_w_pwm_a_pin, Pinout::phase_w_pwm_b_pin},
          {Pinout::phase_w_negated_pwm_a_pin,
           Pinout::phase_w_negated_pwm_b_pin}),
      position_encoder({Pinout::speetec_1_1_pin, Pinout::speetec_2_1_pin,
                        Pinout::speetec_3_1_pin},
                       {Pinout::speetec_1_2_pin, Pinout::speetec_2_2_pin,
      ...
      motor_driver_sensors(
          ...
          {std::array<Pin &, 3>{Pinout::phase_current_u_1_pin,
                                Pinout::phase_current_v_1_pin,
                                Pinout::phase_current_w_1_pin},
           std::array<Pin &, 3>{Pinout::phase_current_u_2_pin,
                                Pinout::phase_current_v_2_pin,
                                Pinout::phase_current_w_2_pin},
           std::array<Pin &, 3>{Pinout::phase_current_u_3_pin,
                                Pinout::phase_current_v_3_pin,
                                Pinout::phase_current_w_3_pin},
           std::array<Pin &, 3>{Pinout::phase_current_u_4_pin,
